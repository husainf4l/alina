...
public class CustomOffersController : ControllerBase
{
    ...
    private readonly IHubContext<alina_backend.app.notifications.NotificationHub> _notificationHub;

    public CustomOffersController(AppDbContext context, ILogger<CustomOffersController> logger, IHubContext<alina_backend.app.notifications.NotificationHub> notificationHub)
    {
        _context = context;
        _logger = logger;
