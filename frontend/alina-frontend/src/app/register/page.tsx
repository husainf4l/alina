    ...
    <>
      ...
      <div className="min-h-screen flex pt-16 bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
          <div className="absolute top-20 -right-20 w-96 h-96 bg-gradient-to-br from-secondary-500/30 to-primary-500/30 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 -left-20 w-96 h-96 bg-gradient-to-br from-primary-500/20 to-secondary-500/20 rounded-full blur-3xl"></div>
          <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
            <div className="max-w-md">
              <h1 className="text-5xl md:text-6xl font-semibold mb-6 tracking-tight">Start Your Journey</h1>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 overflow-y-auto">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`p-4 border-2 rounded-2xl transition-all duration-200 font-medium ${
                    accountType === 'client'
          ...
          <form className="space-y-5" onSubmit={handleRegister}>
            ...
            <div>
              <div className="flex items-start">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm font-medium text-gray-700">
                  I agree to the{' '}
                  <Link href="/terms" className="text-gray-900 hover:text-gray-700 font-semibold underline underline-offset-4 decoration-2">
                    Terms &amp; Conditions
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-gray-900 hover:text-gray-700 font-semibold underline underline-offset-4 decoration-2">
                    Privacy Policy
                  </Link>
                </label>
              </div>
            ...
            <button
              ...
              className="w-full flex justify-center items-center px-6 py-4 border-2 border-gray-200 rounded-2xl text-gray-900 bg-white hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-all duration-200 font-medium shadow-sm hover:shadow-md"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="font-semibold text-gray-900 hover:text-gray-700 transition-colors underline underline-offset-4 decoration-2">
                Sign in
              </Link>
            </p>
          </div>
