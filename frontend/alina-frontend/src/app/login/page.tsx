    ...
    <>
      ...
      <div className="min-h-screen flex pt-16 bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
          <div className="absolute top-20 -right-20 w-96 h-96 bg-gradient-to-br from-primary-500/30 to-secondary-500/30 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 -left-20 w-96 h-96 bg-gradient-to-br from-secondary-500/20 to-primary-500/20 rounded-full blur-3xl"></div>
          <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
            <div className="max-w-md">
              <h1 className="text-5xl md:text-6xl font-semibold mb-6 tracking-tight">Welcome to Alina</h1>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-semibold text-gray-900 hover:text-gray-700 transition-colors underline underline-offset-4 decoration-2">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/register" className="font-semibold text-gray-900 hover:text-gray-700 transition-colors underline underline-offset-4 decoration-2">
                Sign up for free
              </Link>
            </p>
          </div>
